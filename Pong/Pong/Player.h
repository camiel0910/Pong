...
const struct 
{
	std::vector<Vertex> vertices{
		...
		//0.5f,-0.5f,0.0f,
		//0.0f,-0.5f,0.0f
		Vertex(glm::vec3(-0.5f,-0.5f,-1.0f),glm::vec4(1,0,0,1),glm::vec2(1.0f,0.0f),glm::vec3(0.0f,0.0f,1.0f)),
		Vertex(glm::vec3(0.5f,-0.5f,-1.0f),glm::vec4(1,0,0,1),glm::vec2(1.0f,0.0f),glm::vec3(0.0f,0.0f,1.0f)),
		Vertex(glm::vec3(0.0f,-0.5f,-1.0f),glm::vec4(1,0,0,1),glm::vec2(1.0f,0.0f),glm::vec3(0.0f,0.0f,1.0f)),
